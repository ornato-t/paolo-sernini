...
<div class="hero min-h-screen bg-gradient-to-b from-emerald-200 via-cyan-200 to-blue-300">
    <div class="hero-content text-start">
        <div class="max-w-full lg:max-w-6xl">
            <h1 class="mb-4 lg:mb-8 mt-4 lg:mt-6 px-4 lg:px-12 text-2xl lg:text-5xl font-bold text-center">
                La cura si nasconde sempre dietro alla domanda
                <span class="text-rose-500">giusta</span>
                al momento
                <span class="text-rose-500">giusto</span>
            </h1>
